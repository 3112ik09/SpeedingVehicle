    ...
    while True:
        ...
        for i in carLocation1.keys():
            if frameCounter % 1 == 0:
                ...
                cv2.putText(img, "Speed Detection Zone", (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255), 2)
                ...
                if [x1, y1, w1, h1] != [x2, y2, w2, h2]:
                    ...
                    if speed[i] != None and y1 > 60 and y1 < 270:
                        ...
                        if finalData.get(i) == None:
                            ...
                            k = finalData.get(i)[1] = (finalData.get(i)[1] + speed[i]) // 2
                            #print("k  == ", k)

                        cv2.rectangle(img, (x2, y2), (x2 + w1, y2 + h1), rectangleColor, 2)
